...
# Version 4.0 12/20/08
#     Python 3.0 Port (Thanks for Andrew Harrington for initial porting)
#     Fixed raw tk code in Image constructor causing crash in Windows
#       (reported by John Rabung)
