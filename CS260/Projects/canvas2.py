...
class Canvas(object):
    ...
    def refX(self):
        refMat1 = [[1,0,0],[0,-1,0],[0,0,1]]
        self.transform = matMult(self.transform,refMat1)

    def refY(self):
        refMat = [[-1,0,0],[0,1,0],[0,0,1]]
        self.transform = matMult(self.transform,refMat)



    def sheerX(self,s):
        sheerx = [[1,s,0],[0,1,0],[0,0,1]]
        self.transform = matMult(self.transform,sheerx)

    def sheerY(self,s):
        sheery = [[1,0,0],[s,1,0],[0,0,1]]
        self.transform = matMult(self.transform,sheery)
